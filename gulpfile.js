...
gulp.task('watch', gulp.series('css', 'concat-js', function () {
    ...
    gulp.watch('./assets/scss/**/*.scss').on('change', gulp.series('css'));
    gulp.watch(['./assets/js/**/*.js', '!./assets/js/app.bundle.min.js']).on('change', gulp.series('concat-js', browserSync.reload));
